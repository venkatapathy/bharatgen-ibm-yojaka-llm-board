...
# ---------------------------------------------------------------------------
# Prompt (same rules as apps/pyq_module/tasks.py)
# ---------------------------------------------------------------------------
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Extract structured PYQ questions from OCR text"
    )
    parser.add_argument("ocr_file", help="Path to OCR / plain-text file")
    parser.add_argument("-o", "--output", default="questions.json", help="Output JSON")
    parser.add_argument(
        "--model",
        default="ollama/gemma2:9b",
        help="LiteLLM model id (default: ollama/gemma2:9b)",
    )
    parser.add_argument(
        "--api-base",
        default=None,
        help="Optional API base (e.g. http://127.0.0.1:11434 for Ollama)",
    )
